...
{
public:
	double bufferMin[App::count_sensors][App::zonesCount];	///<Вычисленные данные разбитые по датчикам изонам
	double bufferMax[App::count_sensors][App::zonesCount];	///<Вычисленные данные разбитые по датчикам изонам
	char status[App::count_sensors][App::zonesCount];	///< статус данных по датчикам изонам
	char commonStatus[App::zonesCount];					///< общий статус по зонам
